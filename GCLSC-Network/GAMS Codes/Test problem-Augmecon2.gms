...
sets
    ...
    s index of supplier /1*4/
    k index of custoner location /1*5/
    r index for potential locations for distribution center /1*5/
    ...
    n index for potential locations for recycling center /1*5/
    t index of period time  /1*4/
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
    ...
    RRP(j)=uniform(0.4,0.45);
    RRM(j)=uniform(RRP(j),0.45);
    RRO(j)=uniform(RRM(j),0.45);
    RTP(j)=uniform(0.6,0.8);
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
    ...
    loop((j,t),
    ur(j,t)=uniform(0.6,0.9);
    uru(j,t)=uniform(0.6,0.7);
    CSP(j,t)=uniform(250,257);
    CSM(j,t)=uniform(CSP(j,t),257);
    CSO(j,t)=uniform(CSM(j,t),257);
    );
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
parameters
...
parameters
    ...
    loop((i,t),
    fcPP(i,t)=round(uniform(850,1050));
    fcPM(i,t)=round(uniform(850,fcPP(i,t)));
    fcPO(i,t)=round(uniform(850,fcPM(i,t)));
    );
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
parameters
    ...
    loop((r,t),
    fcDP(r,t)=round(uniform(850,1050));
    fcDM(r,t)=round(uniform(850,fcDP(r,t)));
    fcDO(r,t)=round(uniform(850,fcDM(r,t)));
    );
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
parameters
    ...
    loop((l,t),
    fcCP(l,t)=round(uniform(850,1050));
    fcCM(l,t)=round(uniform(850,fcCP(l,t)));
    fcCO(l,t)=round(uniform(850,fcCM(l,t)));
    );
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
parameters
    ...
    loop((n,t),
    fcNP(n,t)=round(uniform(850,1050));
    fcNM(n,t)=round(uniform(850,fcNP(n,t)));
    fcNO(n,t)=round(uniform(850,fcNM(n,t)));
    );
...
parameters
    ...
    loop((r,t),
    capDP(r,t)=round(uniform(4000,5045));
    capDM(r,t)=round(uniform(capDP(r,t),5045));
    capDO(r,t)=round(uniform(capDM(r,t),5045));
    );
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
parameters
...
parameters
    ...
    loop((m,t),
    capLP(m,t)=round(uniform(22,25));
    capLM(m,t)=round(uniform(capLP(m,t),25));
    capLO(m,t)=round(uniform(capLM(m,t),25));
    );
...
parameters
    ...
    loop((j,n,t),
    RCP(j,n,t)=round(uniform(30,35));
    RCM(j,n,t)=round(uniform(30,RCP(j,n,t)));
    RCO(j,n,t)=round(uniform(30,RCM(j,n,t)));
    );
*-*-*-*-*-*-*-*-*-*-*-* Holding Cost *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
parameters
    ...
    loop((j,r,t),
    HCP(j,r,t)=uniform(38.3,48.5);
    HCM(j,r,t)=uniform(38.3,HCP(j,r,t));
    HCO(j,r,t)=uniform(38.3,HCM(j,r,t));
    );
*-*-*-*-*-*-*-*-*-*-*-* Shortage Cost *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
parameters
...
*-*-*-*-*-*-*-*-*-*-*-* Demand *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
    ...
    loop((j,k,t),
    SHCP(j,k,t)=uniform(49,58);
    SHCM(j,k,t)=uniform(49,SHCP(j,k,t));
    SHCO(j,k,t)=uniform(49,SHCM(j,k,t));
    deP(j,k,t)=uniform(4715,4720);
    deM(j,k,t)=uniform(deP(j,k,t),4720);
    deO(j,k,t)=uniform(deM(j,k,t),4720);
    );
*-*-*-*-*-*-*-*-*-*-*-* Selling price *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
parameters
    ...
    loop((j,i,r,t),
    SP(j,i,r,t)=round(uniform(1500,1670));
    SM(j,i,r,t)=round(uniform(SP(j,i,r,t),1670));
    SO(j,i,r,t)=round(uniform(SM(j,i,r,t),1670));
    );
...
parameters
    ...
    loop((m,s,i,t),
    ftSP(m,s,i,t)=uniform(11,21);
    ftSM(m,s,i,t)=uniform(11,ftSP(m,s,i,t));
    ftSO(m,s,i,t)=uniform(11,ftSM(m,s,i,t));
    );
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
parameters
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
    ...
    loop((m,i,r,k,l,n,t),
    ftPP(m,i,r,t)=uniform(15,21);
    ftPM(m,i,r,t)=uniform(15,ftPP(m,i,r,t));
    ftPO(m,i,r,t)=uniform(15,ftPM(m,i,r,t));
    ftDP(m,r,k,t)=uniform(15,21);
    ftDM(m,r,k,t)=uniform(15,ftDP(m,r,k,t));
    ftDO(m,r,k,t)=uniform(15,ftDM(m,r,k,t));
    ftKP(m,k,l,t)=uniform(15,21);
    ftKM(m,k,l,t)=uniform(15,ftKP(m,k,l,t));
    ftKO(m,k,l,t)=uniform(15,ftKM(m,k,l,t));
    ftNP(m,l,n,t)=uniform(15,21);
    ftNM(m,l,n,t)=uniform(15,ftNP(m,l,n,t));
    ftNO(m,l,n,t)=uniform(15,ftNM(m,l,n,t));
    ftCP(m,l,i,t)=uniform(15,21);
    ftCM(m,l,i,t)=uniform(15,ftCP(m,l,i,t));
    ftCO(m,l,i,t)=uniform(15,ftCM(m,l,i,t));
    );
...
parameters
    ...
    loop((m,s,i,t),
    tcSP(m,s,i,t)=uniform(0.8,1);
    tcSM(m,s,i,t)=uniform(0.8,tcSP(m,s,i,t));
    tcSO(m,s,i,t)=uniform(0.8,tcSM(m,s,i,t));
    );
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
    ...
    tcPP(m,j,i,r,t)=uniform(0.8,0.97);
    tcPM(m,j,i,r,t)=uniform(0.8,tcPP(m,j,i,r,t));
    tcPO(m,j,i,r,t)=uniform(0.8,tcPM(m,j,i,r,t));
    tcDP(m,j,r,k,t)=uniform(0.8,0.97);
    tcDM(m,j,r,k,t)=uniform(0.8,tcDP(m,j,r,k,t));
    tcDO(m,j,r,k,t)=uniform(0.8,tcDM(m,j,r,k,t));
    tcKP(m,j,k,l,t)=uniform(0.8,0.97);
    tcKM(m,j,k,l,t)=uniform(0.8,tcKP(m,j,k,l,t));
    tcKO(m,j,k,l,t)=uniform(0.8,tcKM(m,j,k,l,t));
    tcNP(m,j,l,n,t)=uniform(0.8,0.97);
    tcNM(m,j,l,n,t)=uniform(0.8,tcNP(m,j,l,n,t));
    tcNO(m,j,l,n,t)=uniform(0.8,tcNM(m,j,l,n,t));
    tcCP(m,j,l,i,t)=uniform(0.8,0.97);
    tcCM(m,j,l,i,t)=uniform(0.8,tcCP(m,j,l,i,t));
    tcCO(m,j,l,i,t)=uniform(0.8,tcCM(m,j,l,i,t));
    );
*-*-*-*-*-*-*-*-*-*-*-* Variables *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
  ...
  variables
       ...
       Binary variables
           ...
           ZZ(l,t)          collection center is located
...
*-*-*-*-*-*-*-*-*-*-*-* Objective functions *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
 ...
 obj11    .. Z1 =e= sum((m,j,i,r,t),TPP(m,j,i,r,t)*((SP(j,i,r,t)+2*SM(j,i,r,t)+SO(j,i,r,t))/4))-
                    ...
                    sum((l,t),ZZ(l,t)*((fcCO(l,t)+2*fcCM(l,t)+fcCP(l,t))/4))-
                    sum((n,t),B(n,t)*((fcNO(n,t)+2*fcNM(n,t)+fcNP(n,t))/4))-
                    sum((s,t),W(s,t)*((fcSO(s,t)+2*fcSM(s,t)+fcSP(s,t))/4));

obj2(H)$(ord(H)=2)..  Z(H)=e=z2 ;
obj21    ..  z2=e= sum((m,s,i,t),TRS(m,s,i,t)*((tetaO(m)+2*tetaM(m)+tetaP(m))/4)*eS(s,i))+
                   ...
                   sum((l,t),ZZ(l,t)*((EICO(l,t)+2*EICM(l,t)+EICP(l,t))/4))+
...
*-*-*-*-*-*-*-*-*-*-*-* Constraints *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
  ...
  eq13(m,s,i,t)..                  ((1-Beta)*((vrM+vrP)/2)+(Beta)*((vrM+vrO)/2))*TRS(m,s,i,t)=l=(Beta*((capLM(m,t)+capLO(m,t))/2)+(1-Beta)*((capLM(m,t)+capLP(m,t))/2))*NS(m,s,i,t);
  ...
  eq24(l,t)..                      sum((m,j,k),TPK(m,j,k,l,t))=l=((1-Beta)*((capCM(l,t)+capCO(l,t))/2)+(Beta)*((capCM(l,t)+capCP(l,t))/2))*ZZ(l,t);
...
$ontext
C1=sum((j,i,t),QP.l(j,i,t)*((cPO(j,i,t)+2*cPM(j,i,t)+cPP(j,i,t))/4));
C2=sum((s,t),QR.l(s,t)*((cRO(s,t)+2*cRM(s,t)+cRP(s,t))/4));
C3=sum((m,s,i,t),TRS.l(m,s,i,t)*((tcSO(m,s,i,t)+2*tcSM(m,s,i,t)+tcSP(m,s,i,t))/4)*eS(s,i))+
   sum((m,j,i,r,t),TPP.l(m,j,i,r,t)*((tcPO(m,j,i,r,t)+2*tcPM(m,j,i,r,t)+tcPP(m,j,i,r,t))/4)*eP(i,r))+
   sum((m,j,r,k,t),TPD.l(m,j,r,k,t)*((tcDO(m,j,r,k,t)+2*tcDM(m,j,r,k,t)+tcDP(m,j,r,k,t))/4)*eD(r,k))+
   sum((m,j,k,l,t),TPK.l(m,j,k,l,t)*((tcKO(m,j,k,l,t)+2*tcKM(m,j,k,l,t)+tcKP(m,j,k,l,t))/4)*eK(k,l))+
   sum((m,j,l,i,t),TPC.l(m,j,l,i,t)*((tcCO(m,j,l,i,t)+2*tcCM(m,j,l,i,t)+tcCP(m,j,l,i,t))/4)*eC(l,i));
C4=sum((m,s,i,t),NS.l(m,s,i,t)*((ftSO(m,s,i,t)+2*ftSM(m,s,i,t)+ftSP(m,s,i,t))/4))+
   sum((m,i,r,t),NP.l(m,i,r,t)*((ftPO(m,i,r,t)+2*ftPM(m,i,r,t)+ftPP(m,i,r,t))/4))+
   sum((m,r,k,t),ND.l(m,r,k,t)*((ftDO(m,r,k,t)+2*ftDM(m,r,k,t)+ftDP(m,r,k,t))/4))+
   sum((m,k,l,t),NK.l(m,k,l,t)*((ftKO(m,k,l,t)+2*ftKM(m,k,l,t)+ftKP(m,k,l,t))/4))+
   sum((m,l,i,t),NC.l(m,l,i,t)*((ftCO(m,l,i,t)+2*ftCM(m,l,i,t)+ftCP(m,l,i,t))/4))+
   sum((m,l,n,t),NN.l(m,l,n,t)*((ftNO(m,l,n,t)+2*ftNM(m,l,n,t)+ftNP(m,l,n,t))/4));
C5=sum((j,r,t),ID.l(j,r,t)*((HCO(j,r,t)+2*HCM(j,r,t)+HCP(j,r,t))/4));
C6=sum((j,k,t),SH.l(j,k,t)*((SHCO(j,k,t)+2*SHCM(j,k,t)+SHCP(j,k,t))/4));
C7=sum((i,t),X.l(i,t)*((fcPO(i,t)+2*fcPM(i,t)+fcPP(i,t))/4))+
   sum((r,t),Y.l(r,t)*((fcDO(r,t)+2*fcDM(r,t)+fcDP(r,t))/4))+
   sum((l,t),ZZ.l(l,t)*((fcCO(l,t)+2*fcCM(l,t)+fcCP(l,t))/4))+
   sum((n,t),B.l(n,t)*((fcNO(n,t)+2*fcNM(n,t)+fcNP(n,t))/4))+
   sum((s,t),W.l(s,t)*((fcSO(s,t)+2*fcSM(s,t)+fcSP(s,t))/4));

   Results('production costs')=C1;
   Results('purchased raw material costs')=C2;
   Results('Variable transportation costs')=C3;
   Results('Fixed transportation costs')=C4;
   Results('Holding costs')=C5;
   Results('lack of inventory costs')=C6;
   Results('opening facilities costs')=C7;
...
display C1;
display '----------------------------------------'
display 'cost of purchased raw material'
display C2;
display '----------------------------------------'
display 'Variable cost of transportation';
display C3;
display '----------------------------------------'
display 'Fixed-cost of transportation'
display C4;
display '----------------------------------------'
display 'Holding cost';
display C5;
display '----------------------------------------'
display 'lack of inventory cost'
display C6;
display '----------------------------------------'
display 'Cost of opening facilities';
display C7;
$offtext
put /;
